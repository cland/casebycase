...
<html>
	...
	<body>
		<a href="#create-empLeave" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-empLeave" class="content scaffold-create" role="main">
			...
			<div id="tabs" style="display: none;">
				...
				<div id="tab-1">
					<g:form url="[resource:empLeaveInstance, action:'save']" >
						<fieldset class="form">
