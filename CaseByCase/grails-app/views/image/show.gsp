			...
			<div id="tabs" style="display: none;">
				...
				<div id="tab-1">
					<ol class="property-list image">
							...
							<g:if test="${imageInstance?.locations}">
							<li class="fieldcontain">
								<span id="locations-label" class="property-label"><g:message code="image.locations.label" default="Locations" /></span>
								
									<span class="property-value" aria-labelledby="locations-label"><g:fieldValue bean="${imageInstance}" field="locations"/></span>
