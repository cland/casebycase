...
<html>
	...
	<body>
		<a href="#edit-municipality" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-municipality" class="content scaffold-edit" role="main">
			...
			<div id="tabs" style="display: none;">
				...
				<div id="tab-1">
					<g:form url="[resource:municipalityInstance, action:'update']" method="PUT" >
						<g:hiddenField name="version" value="${municipalityInstance?.version}" />
						<fieldset class="form">
