		...
		<div id="list-eviction" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="yearsLived" title="${message(code: 'eviction.yearsLived.label', default: 'Years Lived')}" />
					
						<g:sortableColumn property="networkMember" title="${message(code: 'eviction.networkMember.label', default: 'Network Member')}" />
					
						<g:sortableColumn property="specify" title="${message(code: 'eviction.specify.label', default: 'Specify')}" />
					
						<g:sortableColumn property="landRights" title="${message(code: 'eviction.landRights.label', default: 'Land Rights')}" />
				...
				<g:each in="${evictionInstanceList}" status="i" var="evictionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: evictionInstance, field: "yearsLived")}</td>
					
						<td>${fieldValue(bean: evictionInstance, field: "networkMember")}</td>
					
						<td>${fieldValue(bean: evictionInstance, field: "specify")}</td>
					
						<td>${fieldValue(bean: evictionInstance, field: "landRights")}</td>
