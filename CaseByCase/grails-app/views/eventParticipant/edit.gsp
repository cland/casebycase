...
<html>
	...
	<body>
		<a href="#edit-eventParticipant" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-eventParticipant" class="content scaffold-edit" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${eventParticipantInstance}" var="error">
			...
			<div id="tabs" style="display: none;">
				...
				<div id="tab-1">
					<g:form url="[resource:eventParticipantInstance, action:'update']" method="PUT" >
