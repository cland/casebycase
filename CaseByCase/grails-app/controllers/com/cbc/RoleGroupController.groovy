...
class RoleGroupController {
    ...
    def save(RoleGroup roleGroupInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'roleGroupInstance.label', default: 'RoleGroup'), roleGroupInstance.toString()])
    ...
    def update(RoleGroup roleGroupInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'RoleGroup.label', default: 'RoleGroup'), roleGroupInstance.toString()])
                redirect roleGroupInstance
            }
    ...
    def delete(RoleGroup roleGroupInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'RoleGroup.label', default: 'RoleGroup'), roleGroupInstance.toString()])
