...
class DistrictController {
    ...
    def save(District districtInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'districtInstance.label', default: 'District'), districtInstance.toString()])
    ...
    def update(District districtInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'District.label', default: 'District'), districtInstance.toString()])
                redirect districtInstance
            }
    ...
    def delete(District districtInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'District.label', default: 'District'), districtInstance.toString()])
