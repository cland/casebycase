...
class CaseStatusController {
    ...
    def save(CaseStatus caseStatusInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'caseStatusInstance.label', default: 'CaseStatus'), caseStatusInstance.toString()])
    ...
    def update(CaseStatus caseStatusInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'CaseStatus.label', default: 'CaseStatus'), caseStatusInstance.toString()])
                redirect caseStatusInstance
            }
    ...
    def delete(CaseStatus caseStatusInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'CaseStatus.label', default: 'CaseStatus'), caseStatusInstance.toString()])
