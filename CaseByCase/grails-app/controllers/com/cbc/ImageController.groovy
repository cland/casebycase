...
class ImageController {
    ...
    def save(Image imageInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'imageInstance.label', default: 'Image'), imageInstance.toString()])
    ...
    def update(Image imageInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'Image.label', default: 'Image'), imageInstance.toString()])
                redirect imageInstance
            }
    ...
    def delete(Image imageInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'Image.label', default: 'Image'), imageInstance.toString()])
