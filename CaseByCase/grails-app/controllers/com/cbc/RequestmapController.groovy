...
class RequestmapController {
    ...
    def save(Requestmap requestmapInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'requestmapInstance.label', default: 'Requestmap'), requestmapInstance.toString()])
    ...
    def update(Requestmap requestmapInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'Requestmap.label', default: 'Requestmap'), requestmapInstance.toString()])
                redirect requestmapInstance
            }
    ...
    def delete(Requestmap requestmapInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'Requestmap.label', default: 'Requestmap'), requestmapInstance.toString()])
